...
const t1UserId = insertUser.run('Mr. James Smith', 'j.smith@edurate.school.edu', hash('Teacher@123'), 'teacher', 'Math Teacher').lastInsertRowid;
const t2UserId = insertUser.run('Ms. Emily Chen', 'e.chen@edurate.school.edu', hash('Teacher@123'), 'teacher', 'English Teacher').lastInsertRowid;
const t3UserId = insertUser.run('Dr. Sarah Martinez', 'sarah.martinez@edurate.school.edu', hash('Teacher@123'), 'teacher', 'Science Teacher').lastInsertRowid;
const t4UserId = insertUser.run('Mr. David Kim', 'david.kim@edurate.school.edu', hash('Teacher@123'), 'teacher', 'History Teacher').lastInsertRowid;
const t5UserId = insertUser.run('Ms. Aisha Karimova', 'aisha.karimova@edurate.school.edu', hash('Teacher@123'), 'teacher', 'Russian Teacher').lastInsertRowid;
const t6UserId = insertUser.run('Prof. Robert Taylor', 'robert.taylor@edurate.school.edu', hash('Teacher@123'), 'teacher', 'Arts Teacher').lastInsertRowid;
...
console.log('  Teacher 1:   j.smith@edurate.school.edu            / Teacher@123  (Math)');
console.log('  Teacher 2:   e.chen@edurate.school.edu             / Teacher@123  (English)');
console.log('  Teacher 3:   sarah.martinez@edurate.school.edu     / Teacher@123  (Science)');
console.log('  Teacher 4:   david.kim@edurate.school.edu          / Teacher@123  (Humanities)');
console.log('  Teacher 5:   aisha.karimova@edurate.school.edu     / Teacher@123  (Non-English)');
console.log('  Teacher 6:   robert.taylor@edurate.school.edu      / Teacher@123  (Arts)');
