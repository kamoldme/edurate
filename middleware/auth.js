...
function authenticate(req, res, next) {
  ...
  try {
    ...
    const user = db.prepare('SELECT id, full_name, email, role, grade_or_position, school_id, org_id, verified_status, suspended, avatar_url, language FROM users WHERE id = ?').get(decoded.id);
    if (!user) {
